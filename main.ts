...
scene.onOverlapTile(SpriteKind.Player, assets.tile`myTile6`, function (sprite, location) {
    ...
    if (Level == 12) {
        ...
        tiles.placeOnTile(mySprite, tiles.getTileLocation(2, 11))
    } else if (Level == 13) {
...
let L11 = false
let hit_checkpoint = false
let wall_jump = false
let water__safe = false
